      ...
      <section className="py-20 px-4 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link to="/gallery" className="btn btn-primary btn-lg text-white font-bold px-8 border-none hover:bg-red-700 shadow-lg hover:shadow-red-900/50 transition-all">
              Jelajahi Kegiatan
            </Link>
            <Link to="/about" className="btn btn-outline btn-lg text-black border-2 border-black hover:bg-black hover:text-white font-bold px-8 transition-all">
              Tentang Kami
            </Link>
          </div>
        </div>
      ...
      <section className="py-20 px-4 bg-black text-white relative">
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {/* Card 1 */}
            <div className="group relative bg-neutral rounded-2xl p-8 hover:bg-gray-900 transition-all duration-300 hover:-translate-y-2 border border-gray-800 hover:border-primary">
              <div className="absolute top-0 right-0 p-4 opacity-10 group-hover:opacity-20 transition-opacity">
                <Shield size={120} />
              </div>
              <div className="w-16 h-16 bg-primary rounded-xl flex items-center justify-center mb-6 shadow-lg shadow-red-900/50 group-hover:scale-110 transition-transform">
            ...
            {/* Card 2 */}
            <div className="group relative bg-neutral rounded-2xl p-8 hover:bg-gray-900 transition-all duration-300 hover:-translate-y-2 border border-gray-800 hover:border-white">
              <div className="absolute top-0 right-0 p-4 opacity-10 group-hover:opacity-20 transition-opacity">
                <Target size={120} />
              </div>
              <div className="w-16 h-16 bg-white rounded-xl flex items-center justify-center mb-6 shadow-lg shadow-white/20 group-hover:scale-110 transition-transform">
